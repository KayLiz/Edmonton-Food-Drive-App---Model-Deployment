...
def machine_learning_modeling():
    ...
    if st.button("Predict"):
        ...
        model = joblib.load('donation_bags_model.pkl')

        # Prepare input data for prediction
        input_data = [[routes_completed, time_spent, adult_volunteers, doors_in_route, youth_volunteers, Ward]]
